...
% \resumeSubItem{Image / Video Processing library}{}
%     \resumeItemListStart
%         \resumeItemWithoutTitle{}{Wrote an efficient library able to perform different image / video transformations including background removal and edge detection in C. }
%     \resumeItemListEnd
