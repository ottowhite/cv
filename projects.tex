...
\titleAndDate{Scalable Access Control System for Disaggregated Cloud}{November 2023 - March 2024}
\begin{itemize}[leftmargin=10pt]
    ...
    % \item\normalText{Worked with custom TCP/InfiniBand transport code, distributed tooling}
\end{itemize}
